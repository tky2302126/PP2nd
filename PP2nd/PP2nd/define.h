...
constexpr auto CAMERA_VROTATE = 60.0f; //カメラの水平角
...
constexpr VECTOR CAMERA_END_POS = { 10 * MAP_UNIT / 2, CAMERA_HEIGHT * 2, 10 * MAP_UNIT / 2 - CAMERA_Z_OFFSET * 10 };
constexpr VECTOR CAMERA_END_TARGET = { 10 * MAP_UNIT / 2, 0, 10 * MAP_UNIT / 2 };
